...
def _(model):
    ...
    identified_estimand = model.identify_effect(proceed_when_unidentifiable=_____)
...
def _(CausalModel, causal_graph, data):
    ...
    identified_estimand_eng = model_eng.identify_effect(proceed_when_unidentifiable=_____)
